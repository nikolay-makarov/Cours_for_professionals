...
result = {}
for obj in data:
    if obj['TypeObject'] not in result or obj['SeatsCount'] > result[obj['TypeObject']][1]:
        result[obj['TypeObject']] = [obj['Name'], obj['SeatsCount']]

for obj in sorted(result):
    print(f'{obj}: {result[obj][0]}, {result[obj][1]}')
