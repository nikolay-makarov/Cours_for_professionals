...
причем если пары из первого и второго объектов имеют совпадающие ключи, то значение следует взять из второго объекта.
...
with open('data_merge.json', 'w', encoding='utf-8') as out_file:
    json.dump(data1 | data2, out_file)
