...
with open('student_counts.csv', 'r', encoding='utf-8') as file, \
        open('sorted_student_counts.csv', 'w', encoding='utf-8', newline='') as out_file:
    reader = csv.DictReader(file)
    columns = ['year'] + sorted(reader.fieldnames[1:], key=lambda x: (int(x[:-2]), x[-1]))
